...
export default function Warranty() {
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <p className="text-neutral-300 mb-6">
          ...
          вживані форсунки Common Rail, паливні насоси високого тиску (ПНВТ/ПНВТ) та
          керувальні клапани.
        </p>
        ...
        <section className="space-y-6 text-neutral-200 leading-relaxed">
          ...
          <div className="rounded-2xl border border-neutral-800 p-5">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Перевірка ПНВТ/ПНВТ на відсутність стружки; перевірка регуляторів/клапанів
  ...
  <h2 className="text-xl font-semibold">Коротко про гарантію та повернення</h2>
  <ul className="list-disc pl-5 space-y-2">
    <li>Повернення товару належної якості — протягом <b>14 календарних днів</b> з дати отримання.</li>
    <li>Гарантія: <b>6 місяців</b> для форсунок і ПНВТ; <b>14 днів</b> — для інших товарів.</li>
    <li>Повернення здійснюється через «Нову пошту» після погодження з менеджером.</li>
    <li>Для рекламації потрібні: встановлення на СТО, акт виконаних робіт/наряд‑замовлення, дати монтажу/демонтажу, офіційний документ СТО, збережені тест‑плани, перевірка сумісності перед установкою, фіксація пробігу до/після, опис дефектів до і під час експлуатації.</li>
  </ul>
</section>
